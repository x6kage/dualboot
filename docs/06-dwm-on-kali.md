...
> **どちらを選ぶか**: Kali 既定の Xfce を絞るだけでもかなり軽くなり、CPU モニタ等のパネルプラグインも既定で揃っています(`docs/09-light-xfce-on-kali.md`)。「**ハック性・カスタマイズ性**」が目的なら本書 (dwm)、「**実用上の軽さと Kali 流儀との整合**」が目的なら docs/09 の Xfce 路線をおすすめします。
